...
export class Track extends Component {
  ...
  render() {
    const buttons = {[TrackMode.Random]:<button onClick={() => this.props.dispatch({type:"playing",payload:{id:this.props.id}})}
    ...
    const titles = { [TrackMode.Random]: <h3>Randomly playing</h3> ,
